            ...
            <div class="max-h-auto mx-auto min-w-64 sm:min-w-80">
                ...
                <form action="{{ route('login.authenticate') }}" method="POST" class="w-full">
                    ...
                    <div class="mb-3 space-y-3">
                        ...
                        @if ($errors->any())
                            <div class="text-red-500 mb-4 w-fit">
                                <ul>
                        ...
                        <div class="space-y-1">
                            <div class="space-y-2">
                                ...
                                <input type="email" class="border-input bg-background ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring flex h-10 w-full rounded-md border px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" placeholder="mail@example.com" name="email" value="{{ old('email') }}" />
